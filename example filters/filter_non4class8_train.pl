...
# Training filter
#
# Produce the subset of a password list that DOES NOT pass 4class8
...
sub usage {
  print
    "filter_non4class8_train.pl <pwd file> [outfile for non-selected passwords]\n";
  print
